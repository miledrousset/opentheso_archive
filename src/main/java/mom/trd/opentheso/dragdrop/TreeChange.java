...
public class TreeChange {
    ...
    /**
     * changeLeafToDirectory méthode pour transformer un noeud qui est feuille
     * de l'arbre en dossier
     *
     * @param draggedNode
     * @param droppedNode
     */
    ...
    /**
     * changeToGroupChild cette méthode aligne le type du noeud sur celui de son
     * père
     *
     * @param dragNode
     * @param dropNode
    ...
    public void changeToGroupChild(TreeNode dragNode, TreeNode dropNode) {
        ...
        switch (((MyTreeNode) dropNode).getType()) {
            case ("group"):
                ((MyTreeNode) dragNode).setType("subGroup");
                break;
            case ("collection"):
            ...
            case ("microTheso"):
                ...
                break;
            case ("subGroup"):
                if (!"subGroup".equals(((MyTreeNode) dragNode).getType())) {
                    ((MyTreeNode) dragNode).setType("dossier");
                }

                break;
            case ("subCollection"):
                if (!"subCollection".equals(((MyTreeNode) dragNode).getType())) {
                    ((MyTreeNode) dragNode).setType("dossier");
                }
            ...
            case ("subThème"):
                ...
                break;
            case ("subMicroTheso"):
                if (((MyTreeNode) dragNode).getType() != "subMicroTheso") {
                    ((MyTreeNode) dragNode).setType("dossier");
                }
    ...
    /**
     * saveExpandedNodes méthode qui parcourt un arbre treeNode pour sauvegarder
     * les neoud étendus dans une arrayList expandedNodes
     *
     * @param root
     */
     ...
     *
     * le top term se déplace dans une hierarchie note : cette fonction est
     * utilisé aussi pour déplacer un top terme en dehors du groupe
     *
     * @param connect
     * @param originNodeIdConcept
     * @param BToriginNode
     ...
     *
     * déplace un sousgroupe vers un autre sous groupe note: c'est la seul façon
     * de déplacer un sous groupe
     *
     * @param connect
     * @param originNodeIdConcept
     * @param BToriginNode
