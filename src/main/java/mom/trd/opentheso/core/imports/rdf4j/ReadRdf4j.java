...
public class ReadRdf4j {
     ...
     * @param is 
     */
    public ReadRdf4j(InputStream is){
    ...
    /**
     * Cette fonction permet de charger un fichier RDF
     * puis le parcourir avec RIO (une API RDF4J)
     * @param is 
     */
    private void  laodModel(InputStream is){
    ...
    /**
     * Permet de lire un fichier RDF précédament 
     * charger avec la fonction laodModel()
     * les données sont stoqué dans la variable thesaurus
     */
